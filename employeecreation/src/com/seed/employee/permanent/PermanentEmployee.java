...
public class PermanentEmployee extends Employee {
	...
	public PermanentEmployee(String empFirstName, String empLastName,	LocalDate empDate) {
		pempId++;
		peId = pempId;
	}
	...
	public String toString() {
		return "PermanentEmployee [peId=" + peId + "]";
				//+ ", EmpName=" + getEmpName() + ", EmpSalary=" + calculateSalary() + ", EmpMediclaim=" + mediclaim() + "]";
	}
