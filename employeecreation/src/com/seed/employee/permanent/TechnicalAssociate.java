...
public class TechnicalAssociate extends PermanentEmployee implements Certification {
	...
	public TechnicalAssociate(String empFirstName, String empLastName, LocalDate empDate, int yearsExperience, int noOfCerti, List<String> taCertificate) {
	...
	public String toString() {
		return "PermanentTechnicalAssociateEmployee [peId=" + getPeId() + ", EmpName="
				+ getEmpName() + ", Designation=" + "TA-P" + ", YearsOfExperience=" + yearsExperience + ", EmpCertiList=" + certiList() + ", EmpSalary=" + calculateSalary() + "]";
	}
