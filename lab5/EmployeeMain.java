...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		p1.add(new ProjectManager("Jack", "Smith", "D", LocalDate.of(2023, 10, 20),3));
		p1.add(new TechnicalAssociate("David", "Williams", "C", LocalDate.of(2023, 10, 30),3,3));
		p1.add(new ContractTechnicalAssociate("Jeff", "Brown", "B", LocalDate.of(2024, 1, 20), "Susan",50, 500));
		
		for(Employee pe : p1) {
			System.out.println(pe);			
		}	
		
		Employee e1 = new TechnicalAssociate("David", "Williams", "C", LocalDate.of(2023, 10, 30),3,3);
